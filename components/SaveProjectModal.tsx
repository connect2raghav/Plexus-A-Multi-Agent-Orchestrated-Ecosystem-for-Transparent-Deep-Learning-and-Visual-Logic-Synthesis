...
const SaveProjectModal: React.FC<SaveProjectModalProps> = ({
  ...
  const [status, setStatus] = useState<"draft" | "training" | "completed">("draft");
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <RadioGroup
                  value={status}
                  onValueChange={(value) => setStatus(value as "draft" | "training" | "completed")}
                  orientation="vertical"
                  size="sm"
                >
            ...
            <div className="bg-default-50 rounded-lg p-3 text-sm">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="font-medium text-default-700">Project Details</span>
              </div>
