...
def _get_debugger_agent():
    from orchestration.agents.debugger import DebuggerAgent
    return DebuggerAgent()


def _get_optimizer_agent():
    from orchestration.agents.optimizer import OptimizerAgent
    return OptimizerAgent()


def _get_resource_agent():
    from orchestration.agents.resource import ResourceAgent
...
async def generate_code(req: CodeGenRequest):
    ...
    try:
        from orchestration.core.code_generator import GraphCodeGenerator
...
async def _run_training_job(
    ...
    try:
        ...
        trained = False
        try:
            from orchestration.core.trainer import run_training
