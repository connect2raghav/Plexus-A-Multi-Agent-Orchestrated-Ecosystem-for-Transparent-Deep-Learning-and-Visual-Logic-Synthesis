...
load_dotenv(_HERE / ".env")      # orchestration/.env  (preferred)
...
# ---------------------------------------------------------------------------
from orchestration.agents.data_agent import DataAgent       # noqa: E402
from orchestration.agents.architect import ArchitectAgent   # noqa: E402
